...
<div class="card">
  ...
  <div class="card-body">
    <div class="row">
      <div class="col-md-8">
        <div id="show-pay"
          style="background: #d71149; color:#ffffff; font-size:80px; text-align: center; height: 250px"></div>
        <div id="show-spelling"
          style="background: #ffffff; color: #d71149; font-size: 25px; border:5px solid #d71149; padding: 10px"></div>
      </div>
      ...
      <div class="col-md-4">
        <form class="form form-horizontal form-selling" method="post" action="transaction/save">
          ...
          <div class="form-group">
            <div class="input-group mb-3">
              <input id="member_code" name="member_code" value="0" type="text" class="form-control" placeholder=""
                aria-label="" autofocus required>
              <div class="input-group-append">
          ...
          <div class="section-title">Member Diskon</div>
          <div class="form-group">
